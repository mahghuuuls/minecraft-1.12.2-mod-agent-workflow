---
name: plain-language
description: Re-explain the previous assistant message in much simpler words, for when the answer was too dense, too jargon-heavy, or too formal to follow. Facts stay exact; only the explanation around them gets simpler.
license: MIT
---

# Say it simpler

The user just invoked this skill. Your last message didn't land. It was too dense, too jargon-heavy, or too formal.
...
4. **Light casual flavor.** Casual and direct ("basically...", "the point is...", "ok so..."). A touch of personality is welcome — don't turn it into a meme.
