...
$requiredTemplateHeadings = [ordered]@{
    ...
    'setup/artifact-templates/architecture.md' = @('Components And Responsibilities', 'Dependency Rules', 'Complexity Management', 'Evolution And Implementation Freedom', 'Architectural Decisions And Trade-Offs')
